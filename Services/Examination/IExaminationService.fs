...
type IExaminationService =
    ...
    abstract member Search : string option * userId:UserId * targetId:UserId option * SearchInterval<DateTimeOffset> option * offset:UInt32 * limit:UInt32 -> Async<Result<List<ReportId>, Exception>>
