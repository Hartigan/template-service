...
type IExaminationService =
    ...
    abstract member GetProblemSets : UserId * string option * List<TagModel> * UserId option * SearchInterval<uint32> option * SearchInterval<int32> option * offset:UInt32 * limit:UInt32 -> Async<Result<List<HeadModel>, Exception>>
